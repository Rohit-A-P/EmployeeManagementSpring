...
<body>
    <form:form action="UpdateTrainerById" modelAttribute="trainer">
        <div id="form">
        <h3>UPDATE TRAINER</h3>
        <label>ID  : ${trainer.id}</label>
        <br>
	   ...
	   <label for="dateOfBirth"> Date of birth :</label>
		...
		<button class="button-88" role="button" type="submit">Update Trainer</button>
        </div>
		</form:form>
</body>
