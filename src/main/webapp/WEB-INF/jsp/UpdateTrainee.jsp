...
<body style="margin-left: 38%">
    <form method="POST" action="/EmployeeManagement/UpdateTrainee">
        <lable>ID  : </label>
        <br>  
		...
		<label>Select Gender :</label>
		 ...
		 <input type="radio" path="gender" value="OTHERS">OTHERS<br>
	    <label>Enter Phone number :</label>
	     <input type="text" path="phoneNumber">
	     <br>
	    <label>Enter email :</label>
	     <input type="text" path="email"><br>
		...
		<input type="radio" path="skillCertification1" value="NO">No<br>
		<label>Enter Skill Name :</label>
		...
		<label>Enter Skill Experience :</label> 
		 ...
		 <br>
		<label>Enter Skill Version :</label> 
		 <input type="text" name="skillVersion2">
		 <br>
		<label>Enter Skill Certified(YES/NO) :</label>
		 <input type="radio" path="skillCertification2" value="YES">Yes
		 <input type="radio" path="skillCertification2" value="NO">No
		 <br>
